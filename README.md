...
tiene contratados (IaaS, PaaS, SaaS).
Aunque el equipo de Backend aún no termina la API real, debo dejar lista la
estructura visual y lógica utilizando datos simulados en JavaScript.

Como evidencia se agregan las capturas del funcionamiento de esta práctica
en este repositorio.
